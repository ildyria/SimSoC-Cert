...
let print_error oc msg =
  ...
  | Errors.CTX i -> output_string oc (Camlcoq.extern_atom i)
    (* CompCert-1.9 -> 1.11 *)
  | Errors.CTXL i -> output_string oc (Camlcoq.extern_atom i)
  in
...
let compile_c_file sourcename ifile ofile =
  ...
  let simplifs =
    "b" (* blocks: mandatory *)
      (* CompCert-1.9 -> 1.11, definition "option_fstruct_passing" & 
      "option_fstruct_assign" have been removed. See file /driver/Cflags.ml *)
  ...
  (* CompCert-1.9 -> 1.11 definition "destination_castopt" has been removed,
     and destination_inlining is added.
     See /backend/PrintRTL.ml *)
...
let cmdline_actions =
  ...
  (* CompCert-1.9 -> 1.11, remove print_castopt, add print_inline in Compiler.v *)

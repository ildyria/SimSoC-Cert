...
/* test arm v6 instructions usub16 usub8 usubaddx
...
/* usubaddx (Signed Subtract and Add with Exchange) performs one 16-bit signed integer subtraction and one */
/* 16-bit signed integer addition. It exchanges the two halfwords of the second operand before it performs the */
/* arithmetic. */
/* usubaddx sets the GE bits in the CPSR according to the results. */
void arm_usubaddx(){
  uint32_t x,ge;
  asm("msr cpsr_f, #0\n\t"
      "ssubaddx %0, %2, %3\n\t"
